...
export const moduleProfiles = {
  dinner: {
    ...
    accent: "#16a46a",
    soft: "#eef8f3",
    questionLabel: "先写这顿饭要解决什么",
    questionPlaceholder: "比如：今晚两个人在东边吃点轻松的",
    questionHelp: "一句话写清楚谁吃、在哪里、想避开什么就够了。",
    questionExamples: ["两个人东边轻松吃", "下班后不想排队", "找适合聊天的晚饭"],
    conditionLabel: "再选最影响决定的条件",
    conditionHelp: "先点 2-4 个关键条件，细节放到补充里。",
    customPlaceholder: "补充位置、预算、忌口，比如：我在国贸，对方在常营",
    candidateLabel: "备选餐厅/吃法",
    manualPlaceholder: "每行一个餐厅或吃法\n比如：火锅、日料、轻食",
    autoLabel: "直接推荐",
    manualLabel: "已有备选",
    countLabel: "推荐几种吃法",
    drawSummaryTitle: "先给 3 个可执行方向",
    drawSummary: "没有候选也可以开始，系统会按位置、口味和氛围收口。",
    startLabel: "抽今晚 3 张",
    previewBadge: "吃喝决策",
  ...
  weekend: {
    ...
    accent: "#3554dc",
    soft: "#eef2ff",
    questionLabel: "先写周末想获得什么",
    questionPlaceholder: "比如：周六半天想找个不累的地方放松",
    questionHelp: "写清楚时间、状态和同行对象，地点不确定也没关系。",
    questionExamples: ["周六半天不太累", "下雨也能去", "一个人换换状态"],
    conditionLabel: "再选这次最在意的限制",
    conditionHelp: "时间、体力、天气先定住，路线可以后面再细化。",
    customPlaceholder: "补充时间、区域、同行，比如：只有半天，想在室内",
    candidateLabel: "备选地点/活动",
    manualPlaceholder: "每行一个地点或活动\n比如：影展、露营、书店、Citywalk",
    autoLabel: "直接推荐",
    manualLabel: "已有想法",
    countLabel: "生成几段安排",
    drawSummaryTitle: "先给 3 个轻量安排",
    drawSummary: "不需要先列完整行程，系统会把周末压成几个好执行的选择。",
    startLabel: "抽周末 3 张",
    previewBadge: "周末安排",
  ...
  gift: {
    ...
    accent: "#dd669b",
    soft: "#fff1f7",
    questionLabel: "先写送给谁、为什么送",
    questionPlaceholder: "比如：给刚入职的朋友选 300 元内生日礼物",
    questionHelp: "对象、关系、场景说清楚，礼物方向不用一开始就想好。",
    questionExamples: ["朋友入职生日礼", "拜访长辈带什么", "同事感谢礼物"],
    conditionLabel: "再选最容易踩雷的点",
    conditionHelp: "预算、关系分寸、实用性优先，其余偏好可以补一句。",
    customPlaceholder: "补充预算、关系、禁忌，比如：预算 300 元以内，对方刚入职",
    candidateLabel: "备选礼物",
    manualPlaceholder: "每行一个礼物\n比如：咖啡礼盒、钢笔、桌面灯",
    autoLabel: "直接推荐",
    manualLabel: "已有备选",
    countLabel: "生成几份礼物",
    drawSummaryTitle: "先给 3 个不踩雷礼物",
    drawSummary: "系统会优先控制预算、关系分寸和使用频率。",
    startLabel: "抽礼物 3 张",
    previewBadge: "礼物决策",
  ...
  general: {
    ...
    accent: "#f0b734",
    soft: "#fff8e5",
    questionLabel: "先写现在卡住的选择",
    questionPlaceholder: "比如：这三个方案今天先选哪个？",
    questionHelp: "适合低风险、可回退的选择；重大决定先拆成下一步。",
    questionExamples: ["三个方案今天选哪个", "买不买这个小工具", "今晚先做哪件事"],
    conditionLabel: "再选判断时要守住的标准",
    conditionHelp: "先选最重要的成本、风险或时间标准，别一次塞太多。",
    customPlaceholder: "补充限制或目标，比如：预算有限，希望今天能推进",
    candidateLabel: "候选项",
    manualPlaceholder: "每行一个候选\n比如：方案 A、方案 B、先不做",
    autoLabel: "帮我拆解",
    manualLabel: "已有候选",
    countLabel: "生成几种方向",
    drawSummaryTitle: "先给 3 个下一步",
    drawSummary: "没有明确候选时，系统会先把问题拆成能行动的选项。",
    startLabel: "抽答案卡",
    previewBadge: "通用选择",
