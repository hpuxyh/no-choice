...
const SCENE_TAGS = ["朋友聚餐", "约会吃饭", "一人食", "夜宵"];
const NEED_TAGS = ["离我近", "少排队", "安静好聊", "人均150+"];
const MORE_TAGS = ["火锅", "西餐", "日料", "烧烤"];
