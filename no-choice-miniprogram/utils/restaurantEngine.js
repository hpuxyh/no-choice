...
const RESTAURANT_LOCATION_CAPTURE = "([\\u4e00-\\u9fa5A-Za-z0-9·\\-]{2,24}?)(?=\\s*(?:附近|周边|这边|那边|吃什么|吃啥|吃点什么|吃点啥|吃饭|吃|找|搜|搜索|安排|看看|餐厅|饭店|一个|另一个|一位|另一位|第一个|第二个|第三个|第四个|两个人|三个人|几个人|共?\\d+(?:到|-)?\\d*人|[一二两三四五六七八九十]+人|人均|预算|折中|，|,|。|!|！|\\?|？|；|;|但|但是|不过|可是|朋友|对方|同事|他|她|我们|咱们|大家|一起|$))";
...
async function loadRestaurantDeck({ modeName, choice, coords, setLoading, toast, avoidCardKeys = [] }) {
  ...
  const allowedCity = restaurantAllowedCityFromCoords(center) || restaurantAllowedCityFromCoords(searchCoords);
